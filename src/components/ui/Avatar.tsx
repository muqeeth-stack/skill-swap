...
export default function Avatar({ name, src, size = "md", showBadge = false, isLinkedIn, isGitHub }: AvatarProps) {
  const sizeClasses = {
    sm: "w-8 h-8 text-xs",
  ...
  return (
    <div className="relative inline-flex">
      ...
      {showBadge && (isLinkedIn || isGitHub) && (
        <div className="absolute -bottom-0.5 -right-0.5 flex items-center justify-center w-5 h-5 bg-white rounded-full shadow-sm border border-gray-100">
          {isGitHub && (
